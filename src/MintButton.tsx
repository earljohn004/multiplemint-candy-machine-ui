...
export const MintButton = ({
  ...
  const getMintButtonContent = () => {
    if (isStandard) {
      return getStandardMintButtonContent();
    } else {
      return getPremiumMintButtonContent();
    }
  };

  const getPremiumMintButtonContent = () => {
    if (candyMachine?.state.isSoldOut) {
      return "PREMIUM NFT SOLD OUT";
    } else if (isMinting) {
      ...
      return "PREMIUM WHITELIST MINT";
    }

    return "PREMIUM MINT";
  };

  const getStandardMintButtonContent = () => {
    if (candyMachine?.state.isSoldOut) {
      return "STANDARD NFT SOLD OUT";
    } else if (isMinting) {
      return <CircularProgress />;
    } else if (
      candyMachine?.state.isPresale ||
      ...
      return "STANDARD WHITELIST MINT";
    }

    return "STANDARD MINT";
  };
